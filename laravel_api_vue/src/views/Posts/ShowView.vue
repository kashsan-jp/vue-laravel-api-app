...
<template>
    <main>
        <div v-if="post">
      <div class="border-l-4 border-blue-500 pl-4 ml-4 mt-12">
        ...
        >
            <form @submit.prevent="deletePost(post)">
                <button
                    class="text-red-500 font-bold px-2 py-1 border border-s-red-300"
                    >Delete
                </button>
            </form>
            ...
            <RouterLink
                ...
                class="text-green-500 font-bold px-2 py-1 border border-s-red-300">
                Update
            </RouterLink>
        </div>
